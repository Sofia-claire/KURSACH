...
def check_dependencies():
    ...
    if not os.path.exists(venv_python):
        return False
    try:
        # ✅ ДОБАВЛЕНО: проверка PIL и pystray
        subprocess.check_call(
            [venv_python, "-c", "import customtkinter, pandas, fuzzywuzzy, openpyxl, PIL, pystray"],
...
def main():
    ...
    if not check_dependencies():
        print("❌ Зависимости так и не удалось установить.")
        sys.exit(1)
