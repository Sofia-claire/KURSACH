...
class ConsolidationApp(ctk.CTk):
    ...
    def create_home_frame(self):
        ...
        # Основное описание
        info = (
            "Данная программа разработана для автоматической консолидации финансовых отчётов.\n\n"
        ...
        # Информация об авторе и системе
        author_info = (
            "👤 Автор: Уливанова София\n\n"
            "🔐 Система включает:\n"
    ...
    # ==================== ПЕРЕРИСОВКА ИНТЕРФЕЙСА (ИСПРАВЛЕНИЕ ТЕМЫ) ====================
    def rebuild_ui(self):
        ...
        if self.admin_btn:
            frames_map.extend([("admin", self.admin_frame), ("users", self.users_frame)])

        for name, frm in frames_map:
            if frm and frm.winfo_ismapped():
                current = name
                break
    ...
    def change_theme(self, choice):
        ...
        self.rebuild_ui()  # ✅ Пересоздаёт интерфейс с новой палитрой
